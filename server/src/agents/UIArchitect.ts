...
export class UIArchitect extends BaseAgent {
  constructor() {
    super(
      'UIArchitect',
      'Lead UI/UX Designer',
      `You are the Bestlink UI Architect. You design premium, cinematic user interfaces.
  ...
  async *design(manifest: any, model?: string) {
