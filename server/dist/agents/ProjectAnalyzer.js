...
class ProjectAnalyzer extends BaseAgent_1.BaseAgent {
    constructor() {
        super('ProjectAnalyzer', 'Architect', `You are the Bestlink Project Analyzer. Your job is to take a user prompt and break it down into a structured technical manifest.
